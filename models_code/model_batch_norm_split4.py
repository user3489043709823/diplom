# первая модель где добавляются искуственные признаки
import keras.utils
...
from keras.layers import LocallyConnected2D, Flatten, BatchNormalization, Activation, Reshape, Add
...
average_to_max_oblast_weights = \
    [array([[[[kernel_coef] for i in range(oblast_coef)]]]), array([bias_coef for i in range(oblast_coef)])]
